...
Model Evaluation Phase – YOLOv8 Nano, Small, and Medium models were trained and evaluated
Accuracy Comparison – Models were compared based on segmentation accuracy and performance
Model Selection – DeepLabV3 was chosen due to higher accuracy and better pixel-level segmentation
Input Image – Images are loaded from the assets folder or user input
Preprocessing – Image resizing, normalization, and noise reduction
DeepLabV3 Segmentation – Semantic segmentation produces detailed masks
Soil Detection – Soil regions extracted from segmentation output
Vegetation Segmentation – Vegetation areas isolated accurately
Visualization – Outputs displayed for analysis
🚀 Installation & Usage
...
👨‍💻 Author
Chinna Reddemma Kotam AI & Web Development Enthusiast
